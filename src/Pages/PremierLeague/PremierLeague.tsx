...
// Новая структура данных для эмблем
interface MatchWithEmblems {
  id: number;
  homeTeam: { name: string; crest: string };  // Добавляем свойство crest для эмблемы
  awayTeam: { name: string; crest: string };  // Аналогично для выездной команды
...
function PremierLeague() {
  ...
  const { matches, status, error } = useSelector((state: any) => state.premierLeague);
